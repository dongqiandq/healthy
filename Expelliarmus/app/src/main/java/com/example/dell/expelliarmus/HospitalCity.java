...
public class HospitalCity extends AppCompatActivity implements MySideBar.OnTouchingLetterChangedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hospital_city);

        btnOk=findViewById(R.id.btn_ok);
        mainList = (ListView) findViewById(R.id.mainlist);
        myView = (MySideBar) findViewById(R.id.myview);
        tv01 = (TextView) findViewById(R.id.main_tv01);
//        tv01.setText(getIntent().getStringExtra("city"));
        myView.setOnTouchingLetterChangedListener(this,letterCharList);
        ...
        HospitalAdapter adapter = new HospitalAdapter(this,data,letterCharList,title,R.layout.hospital_item,address);
...
//                  tv01.setText(title[letterCharList.get(firstVisibleItem)]);
                    if (null!=nowLoc && !"".equals(nowLoc)){
                        tv01.setText(nowLoc);
                    }else {
                        tv01.setText("当前城市"+getIntent().getStringExtra("city"));//设置值
                    }
...
//          Toast.makeText(getApplicationContext(), mainList.getItemAtPosition(position)+"我被点击了。。。", 0).show();
                ...
                tv01.setText((CharSequence) mainList.getItemAtPosition(position));//将城市定位的位置换成点击的城市
                nowLoc=mainList.getItemAtPosition(position).toString();
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent=new Intent(HospitalCity.this,MainActivity.class);
                intent.putExtra("id",1);
                intent.putExtra("city",tv01.getText());
    ...
    public void onTouchingLetterChanged(int s) {
        mainList.setSelection(letterPositionList.get(s+1));
    }
