...
/**
 * Servlet implementation class UpdateUserSex
 */
@WebServlet("/UpdateUserSex")
public class UpdateUserSex extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int row=userService.updateUserSexService(id, userSex);
		if(row==0){
